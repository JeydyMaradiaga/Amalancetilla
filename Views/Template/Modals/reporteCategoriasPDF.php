...
<body>
            ...
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION ?> <br>
                       ...
                       <strong><h3>  Reporte Categoría</h3></strong> 
                </td>
                <td class="wd33">
    ...
    <table class="tbl-detalle">
        <thead>
            <tr>
                <th class="">#</th>
                <th class=" text-center" style="width: 241px;">Nombre</th>
                <th class=" text-center" style="width: 230px;">Descripción</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class=" text-center"><?= $datos['Nombre_Categoria'] ?></td>
                    <td class=" text-center"><?= $datos['Descripcion'] ?></td>
                    <td class=" text-center"><?php if ($datos['Estado'] == 1) {
                                                    echo "Activo";
                                                } else {
                                                    echo "Inactivo";
                                                }
