            ...
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION ?> <br>
                       ...
                       <strong><h3>  Preguntas de Seguridad</h3></strong> 
                </td>
                <td class="wd33">
    ...
    <table class="tbl-detalle">
        <thead>
            <tr>
                ...
                <th class=" text-center" style="width: 210px;">Pregunta</th>
                <th class=" text-center" style="width: 210px;">Creado Por</th>
                <th class=" text-center" style="width: 210px;">Fecha de Creación</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class=" text-center"><?= $datos['Pregunta'] ?></td>
