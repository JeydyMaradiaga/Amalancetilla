    ...
    <table class="tbl-detalle">
        <thead>
            <tr>
                ...
                <th class=" text-center" style="width: 80px;">Fecha Movimiento</th>
                <th class=" text-center" style="width: 80px;">Hora Movimiento</th>
                <th class=" text-center" style="width: 100px;">Cant.Movimiento</th>
                <th class=" text-center" style="width: 80px;">Tipo Movimiento</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class=" text-center"><?= $datos['Nombre_movimiento'] ?></td>
