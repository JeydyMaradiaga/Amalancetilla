...
<body>
            ...
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION ?> <br>
                       ...
                       <strong><h3>  Reporte Estado de Usuario</h3></strong> 
                </td>
                <td class="wd33">
    ...
    <table class="tbl-detalle">
        <thead>
            <tr>
                <th class="">#</th>
                <th class=" text-center" style="width: 300px;">Nombre del estado</th>
                <th class=" text-center" style="width: 400px;">Fecha de creación</th>
            </tr>
        </thead>
        <tbody>
            <?php
