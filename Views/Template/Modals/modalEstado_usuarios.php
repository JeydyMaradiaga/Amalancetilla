            ...
            <input type="hidden" id="idEstado_usuario" name="idEstado_usuario" value="">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" oninput="convertirMayusculasYPermitirLetrasYEspacios(this)" class="form-control valid validText" id="txtNombreEstado" name="txtNombreEstado"  required="">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="txtNombreParametro" id="letra">Fecha de creación</label>
                      <input type="text" class="form-control valid validText" id="txtFechaCreacion" name="txtFechaCreacion"  required="" value="<?php echo(date("Y-m-d"));?>" readonly>
                    </div>
                  </div>
