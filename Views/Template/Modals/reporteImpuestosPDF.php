            ...
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION ?> <br>
                       ...
                       <strong><h3>  Reporte Impuesto</h3></strong> 
                </td>
                <td class="wd33">
    ...
    <table class="tbl-detalle">
        <thead>
            <tr>
                ...
                <th class=" text-center" style="width: 230px;">Porcentaje</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class=" text-center"><?= $datos['Nombre_ISV'] ?></td>
                    <td class=" text-center"><?= $datos['Porcentaje_ISV'] ?></td>
                </tr>
            <?php } ?>
        </tbody>
