            ...
            <tr>
                ...
                <td class="text-center wd33">
                    ...
                    <p><?= DIRECCION ?> <br>
                       ...
                       <strong><h3>  Reporte Proveedor</h3></strong> 
                </td>
                <td class="wd33">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class=" text-center"><?= $datos['RTN_Proveedor'] ?></td>
                    <td class=" text-center"><?= $datos['Telefono_Proveedor'] ?></td>
                    <td class=" text-center"><?= $datos['Correo_Proveedor'] ?></td>
                    <td class=" text-center"><?= $datos['Direccion_Proveedor'] ?></td>
                </tr>
            <?php } ?>
        </tbody>
