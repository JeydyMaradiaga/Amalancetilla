...
$subtotal = 0;
$total = 0;
if(isset($_SESSION['arrCarritoT']) and count($_SESSION['arrCarritoT']) > 0){ 
 ?>		
	<!-- Shoping Cart -->
				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							...
							<?php 
							 $ISV11 = 0;
								foreach ($_SESSION['arrCarritoT'] as $producto) {
									$totalProducto = $producto['precio'] * $producto['cantidad'];
									$subtotal += $totalProducto;
									$idProducto = ($producto['idproducto']);
									$ISV11 += $producto['ISV'] *  ($producto['cantidad'] * $producto['precio']) ;
							 ?>
								<tr class="table_row <?= $idProducto ?>">
									<td class="column-1">
										<div class="how-itemcart1" idpr="<?= $idProducto ?>" op="2" onclick="fntdelItem(this)" >
											<img src="<?= media().'/images/uploads/'.$producto['imagen'] ?>" alt="<?= $producto['producto'] ?>">
										</div>
									</td>
									...
									<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											idpr="<?= $idProducto ?>">
												<i class="fs-16 zmdi zmdi-minus" min="1" ></i>
											</div>

											<input class="mtext-104 cl3 txt-center num-product" type="" name="num-product1" value="<?= $producto['cantidad'] ?>" min="1" step="1" idpr="<?= $idProducto ?>">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span id="subTotalCompra" class="mtext-110 cl5">
							...
							<div class="size-209">
								<span class="mtext-110 cl5" id="isv">
									<?= SMONEY.formatMoney($ISV11) ?>
								</span>
							</div>
						</div>
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span id="totalCompra" class="mtext-110 cl5">
									<?= SMONEY.formatMoney($subtotal + 70 + $ISV11) ?>
								</span>
							</div>
						</div>
