...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">Preguntas registradas</div>
      </div>
    </div>
  </div>
  <div class="row">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <button class="btn btn-danger" type="button"  target="_blanck" ><a style="color:white;" href="<?= base_url(); ?>/Parametros/getParametrosR" target="_blanck"> PDF</a></button>
                    ...
                    <thead>
                      <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="sampleTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 5px;">Id Pregunta</th>
                        <th class="sorting" tabindex="0" aria-controls="sampleTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 149.375px;">Pregunta</th>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header headerRegister bg-primary text-white">
                                <h5 class="modal-title" id="titleModal2">Actualizar Pregunta</h5>
                                ...
                                <form id="FormActualizarParametro" name="FormActualizarParametro" class="form-horizontal">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      <label for="txtNombreM" id="letra">Pregunta</label>
                                  ...
                                  <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                      <label for="txtCreacionParametro" id="letra">Fecha de modificacion</label>
                                      <input type="date" class="form-control valid validFechavencimiento" id="txtCreacionParametro" name="txtCreacionParametro" readonly required="">
                                    </div>
                                  </div>

                                  <div class="tile-footer">
                                    <button id="btnActionForm" class="btn btn-primary" type="submit"><span id="btnTextM">Actualizar</span></button>&nbsp;&nbsp;&nbsp;
