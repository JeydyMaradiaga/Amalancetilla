...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tableParametros = $('#tablepromociones').dataTable({ 
        ...
        "columns": [
            { "data": "Id_Promociones","visible": false },
            { "data": "Id_Producto" },
            { "data": "Precio" },
            { "data": "Nombre" },
            { "data": "Descripcion" },
    ...
    var formParametros = document.querySelector('#formPromociones');
    formParametros.onsubmit = function (e) {
        ...
        var strProducto = document.querySelector('#listRolid').value;  
        var strDescripcion = document.querySelector('#txtDescripcion').value; 
        var strvalor = document.querySelector('#txtValor').value; 
       
        var dateFecha1 = document.querySelector('#txtFecha1').value; 
        var dateFecha2 = document.querySelector('#txtFecha2').value; 
        var strestado = document.querySelector('#listStatus2').value;  
...
//actualizar
function fntEditInfo(idpromocion) {
    ...
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    var ajaxUrl = base_url + '/Promociones/getPromocion/'+idpromocion;//lleva a controllers
...
function fntEditParametro(idpromocion) {
