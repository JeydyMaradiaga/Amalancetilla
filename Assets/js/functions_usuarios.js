...
document.addEventListener(
  ...
  function () {
    ...
    formUsuario.onsubmit = function (e) {
      ...
      var strRol = document.querySelector("#listRolid").value;
      var strNombre = document.querySelector("#txtNombre").value;
      var strContrasena = document.querySelector("#txtcontrasena").value;
      var strContrasenac = document.querySelector("#txtcontrasenaC").value;
      ...
      var strEstado = document.querySelector("#txtEstado").value;
