...
INSERT INTO tbl_config_cai VALUES("1","2","","1","999","159","2023-12-27","2A2B6C-49C9A-69D4GD-09F319-1F4D5C-2G");
...
INSERT INTO tbl_descuentos VALUES("14","hdhdh","0","jjdjdj","1");
...
CREATE TABLE `tbl_detalle_compra` (
  ...
  `Nombre_Producto_Comprado` varchar(100) COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`Id_Detalle_Compra`),
  KEY `tbl_detallecompra_tbl_compra_idx` (`Id_Compra`),
  KEY `tbl_detallecompra_tbl_producto_idx` (`Id_Producto`),
  CONSTRAINT `tbl_detallecompra_tbl_compra` FOREIGN KEY (`Id_Compra`) REFERENCES `tbl_compra` (`Id_Compra`),
  CONSTRAINT `tbl_detallecompra_tbl_producto` FOREIGN KEY (`Id_Producto`) REFERENCES `tbl_productos` (`Id_Producto`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;

INSERT INTO tbl_detalle_compra VALUES("1","1","2","12","12","Uvas");
INSERT INTO tbl_detalle_compra VALUES("2","2","21","15","250","Vino de un Litro");
INSERT INTO tbl_detalle_compra VALUES("3","2","21","30","250","Vino de un litro");
...
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
...
INSERT INTO tbl_detalle_pedido VALUES("197","6","22","3","0.00","1","100");
INSERT INTO tbl_detalle_pedido VALUES("207","16","21","3","0.00","2","250");
INSERT INTO tbl_detalle_pedido VALUES("209","18","21","3","0.00","2","250");
INSERT INTO tbl_detalle_pedido VALUES("210","19","21","3","0.00","5","250");
INSERT INTO tbl_detalle_pedido VALUES("211","20","21","3","0.00","10","250");
INSERT INTO tbl_detalle_pedido VALUES("212","21","21","3","0.00","5","250");
INSERT INTO tbl_detalle_pedido VALUES("213","22","21","3","0.00","2","250");
INSERT INTO tbl_detalle_pedido VALUES("214","23","21","3","0.00","1","250");
INSERT INTO tbl_detalle_pedido VALUES("215","24","21","3","0.00","5","250");
INSERT INTO tbl_detalle_pedido VALUES("216","25","21","3","0.00","3","250");
INSERT INTO tbl_detalle_pedido VALUES("217","25","22","3","0.00","5","100");
INSERT INTO tbl_detalle_pedido VALUES("218","26","21","3","0.00","2","250");
INSERT INTO tbl_detalle_pedido VALUES("219","27","21","3","0.00","5","250");
INSERT INTO tbl_detalle_pedido VALUES("220","27","22","3","0.00","5","100");
INSERT INTO tbl_detalle_pedido VALUES("221","28","21","3","0.00","1","250");
INSERT INTO tbl_detalle_pedido VALUES("222","29","21","3","0.00","5","250");
INSERT INTO tbl_detalle_pedido VALUES("223","29","22","3","0.00","1","100");
...
INSERT INTO tbl_inventario VALUES("1","21","15");
INSERT INTO tbl_inventario VALUES("2","22","29");
...
INSERT INTO tbl_movimiento_inventario VALUES("17","21","2023-08-07","21:34:27","5","2","1");
INSERT INTO tbl_movimiento_inventario VALUES("18","22","2023-08-07","21:34:27","1","2","1");
...
) ENGINE=InnoDB AUTO_INCREMENT=163 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
...
INSERT INTO tbl_pedidos VALUES("29","1","1","1","AMALANCETILLA","2023-08-07","1350.00","","0","159","1","1","1");
...
INSERT INTO tbl_productos VALUES("21","1","VINO DE UN LITRO","1001","3","VINO SABOR UVA","250","img_acfd03b78dc5ee09b47deff297635dc3.jpg","2022-11-26 11:31:00","vino-de-un-litro","1","0","5","55");
INSERT INTO tbl_productos VALUES("22","1","JALEA DE 12 ONZAS","1002","3","JALEA SABOR UVA","100","img_4862027c09388125fdd942cf6d30ee90.jpg","2022-11-26 11:33:41","jalea-de-12-onzas","1","0","5","40");
